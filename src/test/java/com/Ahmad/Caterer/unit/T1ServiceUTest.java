...
public class T1ServiceUTest {
	...
	public void testA1SaveCaterer() {
		Caterer caterer = new Caterer("Praveen Kumar Samal", 2, 5,
				new Location("Paradip", "M2/72,Madhuban", 754142, "Odisha"), "9114764472", "9040337039",
				"pks1234@gmail.com");
		try {
	...
	public void testA2KeywordCaterer() {
		...
		Page<Caterer> pageabl = service.getKeywordCaterer(pageable, "tanmaya");
	...
	@Test
	public void testA4findCaterer() {
		Optional<Caterer> caterer = service.findCaterer("60a6903a61fcb16e56e796b3");
		assertNotNull(caterer.get());
	}
}
