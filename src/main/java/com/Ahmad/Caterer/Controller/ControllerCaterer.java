...
//	@GetMapping(value = "/getKeywordCaterer")
//	public ResponseEntity<Page<Caterer>> getKeywordCaterer(Pageable pageable, @RequestParam String keyword) {
//		try {
//			return new ResponseEntity<>(service.getKeywordCaterer(pageable, keyword), HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
//		}
//
